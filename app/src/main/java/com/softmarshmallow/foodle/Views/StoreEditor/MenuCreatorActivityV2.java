...
public class MenuCreatorActivityV2 extends AppCompatActivity
{
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.activity_menu_creator_v2);
                ...
                imagePicker.setImagePickerCallback(
                        new ImagePickerCallback()
                        {
                                ...
                                public void onImagesChosen(List<ChosenImage> images) {
                                        Glide.with(MenuCreatorActivityV2.this).load( images.get(0).getQueryUri()).into(menuPhotoImageView);
                                ...
                                public void onError(String message) {
                                        // Do error handling
                                        new SweetAlertDialog(MenuCreatorActivityV2.this, SweetAlertDialog.ERROR_TYPE)
                                                .setTitleText("Error")
