...
@Deprecated
public class MenuCreatorActivity_Deprecated extends AppCompatActivity
{
        
        private static final String TAG = "MenuCreatorActivity_Deprecated";
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                imagePicker = new ImagePicker(MenuCreatorActivity_Deprecated.this);
        }
        ...
        void CreateMenu() {
                ...
                new MenuService.MenuCreator(
                        MenuData,
                        StoreCreatorActivity_Deprecated.CreatingStoreId,
                ...
                /*
                MenuService.UploadPhotoAndCreateMenu(MenuData, StoreCreatorActivity_Deprecated.CreatingStoreId
                        , new Consumer<MenuModel>()
                        {
                                @Override
                                public void accept(MenuModel menuModel) {
